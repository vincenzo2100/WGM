...
obrazek = Image.open("D:/MC_IO_GR1/lab1/materiały/obrazek.bmp")  # wczytywanie obrazu
obrazek.show()
...
ob_d.save(
    "D:/MC_IO_GR1/lab1/materiały/obrazek_zapisany.bmp")  # jako argument podajemy nazwę pliku wraz z rozszerzeniem, bo w zależności od tego w jakim formacie zapiszemy otrzymamy różne tablice obrazu
...
t1 = np.loadtxt("D:/MC_IO_GR1/lab1/materiały/dane.txt", dtype=np.bool_)
t2 = np.loadtxt("D:/MC_IO_GR1/lab1/materiały/dane.txt", dtype=np.int_)
...
nowa_t1 = np.loadtxt("D:/MC_IO_GR1/lab1/materiały/dane1.txt", dtype=np.bool_)  # wczytanie tablicy z pliku dane1.txt
...
nowa_t2 = np.loadtxt("D:/MC_IO_GR1/lab1/materiały/dane1.txt", dtype=np.int_)  # wczytanie tablicy z pliku dane1.txt
print("--- nowa_t2 -----------")
print(nowa_t2)
print("----- t2 ---------")
print(t2)
...
t2_text = open('D:/MC_IO_GR1/lab1/materiały/t2.txt', 'w')
for rows in t2:
    for item in rows:
